...
# @author - @gabiwaxX
# @dev This contract is used to check if a token in
...
def honeyCheck(
    ...
    buyPath : address[2] = [IUniswapV2Router01(idexRouterAddres).WETH(), _targetTokenAddress]
    sellPath : address[2] = [_targetTokenAddress, IUniswapV2Router01(idexRouterAddres).WETH()]
